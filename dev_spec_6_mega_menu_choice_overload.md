...
## Current state
h1: Wildly Comfortable. Super Natural.; cta: SHOP MEN / SHOP WOMEN; notes: Mega-menu has 20+ items across multiple categories, potentially overwhelming users.

## Required change
h1: Wildly Comfortable. Super Natural.; cta: SHOP MEN / SHOP WOMEN; notes: Simplify mega-menu to top 5-7 categories with clear hierarchy, reduce sub-levels, and use visual hierarchy to guide users.

## Acceptance criteria
- GIVEN a first-time visitor on the affected page
- WHEN the change is live
- THEN Simplify mega-menu to top 5-7 categories with clear hierarchy, reduce sub-levels, and use visual hierarchy to guide users.
